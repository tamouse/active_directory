...
module ActiveDirectory
  ...
  class Base
    ...
    #
    # Returns the result of last LDAP operation
    #
    def self.last_ldap_result
    ...
    # return a hash of the attributes or LDAP entry attributes
    def to_h
      if @attributes.empty?
        Hash[
          @entry.attribute_names.map do |name|
            [ name, @entry[name] ]
          end
        ]
      else
